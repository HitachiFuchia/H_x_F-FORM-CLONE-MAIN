...
const createProjects = () => {
  projects.forEach(project => {
    ...
    let projectDeatails = document.createElement("div");
    projectDeatails.classList.add("project__details");
    ...
    projectDeatails.append(projectTitle, projectType);

    imageContainer.appendChild(image);
    panel.append(imageContainer, projectDeatails);
